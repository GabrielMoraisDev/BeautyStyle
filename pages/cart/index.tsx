      ...
      <div className="w-[90%] m-auto text-center mt-5">
        ...
        {cart.length === 0 ? (
          ...
          <div className='inline lg:flex'>
            ...
            {cart.map((product) => (
              <>
              <div key={product.id} className="inline lg:flex my-5 w-[95%]">
                <Image width={300} height={300} src={`/img${product.imagem}`} alt={product.title} className="w-32 h-32 shadow-lg m-auto" />
