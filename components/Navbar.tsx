...
export default function Navbar({ page }: NavProps) {
    ...
    return (
        ...
        <div className="h-20 w-full bg1 z-50">
            ...
            <a href="https://wa.me/11939320470" target="_blank" className="fixed bottom-3 right-3 bg1 rounded-full w-auto px-6 h-10 flex justify-center place-items-center hover:opacity-75 cursor-pointer duration-300">
                Fale Conosco 
